    ...
    public String process(final CRDBPDXTimelineDataset crdbPDXTimelineDataset) throws Exception {
        ...
        for (String field : new CRDBPDXTimelineDataset().getFieldNames()) {
            ...
            if (field.equals("PARTA_CONSENTED")) {
                ...
                value = resolvePartAConsented(crdbPDXTimelineDataset.getPATIENT_ID());
            } else {
                value = crdbPDXTimelineDataset.getClass().getMethod("get"+field).invoke(crdbPDXTimelineDataset).toString();
            }
