    ...
    public String process(final CRDBPDXSourceToDestinationMapping crdbPDXSourceToDestinationMapping) throws Exception {
        ...
        for (String field : new CRDBPDXSourceToDestinationMapping().getFieldNames()) {
            ...
            if (field.equals("PARTA_CONSENTED")) {
                ...
                value = resolvePartAConsented(crdbPDXSourceToDestinationMapping.getPATIENT_ID());
            } else {
                value = crdbPDXSourceToDestinationMapping.getClass().getMethod("get"+field).invoke(crdbPDXSourceToDestinationMapping).toString();
            }
