...
public class CRDBPDXClinicalSampleReader implements ItemStreamReader<CRDBPDXClinicalSampleDataset> {
    ...
    private List<CRDBPDXClinicalSampleDataset> getCrdbPDXClinicalSampleDatasetResults() {
        ...
        List<CRDBPDXClinicalSampleDataset> crdbPDXClinicalSampleDatasetResults = crdbQueryFactory.selectDistinct(
                Projections.constructor(CRDBPDXClinicalSampleDataset.class, $(qCRDBD.getPATIENT_ID()), $(qCRDBD.getSAMPLE_ID()), $(qCRDBD.getPDX_ID()), $(qCRDBD.getDESTINATION_STUDY_ID()), $(qCRDBD.getAGE_AT_INITIAL_DIAGNOSIS()), $(qCRDBD.getPASSAGE_ID()), $(qCRDBD.getONCOTREE_CODE()), $(qCRDBD.getSTAGE_CODE()), $(qCRDBD.getT_STAGE()), $(qCRDBD.getN_STAGE()), $(qCRDBD.getM_STAGE()), $(qCRDBD.getGRADE()), $(qCRDBD.getSAMPLE_TYPE()), $(qCRDBD.getPRIMARY_SITE()), $(qCRDBD.getSAMPLE_CLASS()), $(qCRDBD.getPROCEDURE_TYPE()), $(qCRDBD.getPRETREATED()), $(qCRDBD.getTREATED()), $(qCRDBD.getER_POSITIVE()), $(qCRDBD.getER_NEGATIVE()), $(qCRDBD.getHER2_POSITIVE()), $(qCRDBD.getHER2_NEGATIVE()), $(qCRDBD.getHPV_POSITIVE()), $(qCRDBD.getHPV_NEGATIVE()), $(qCRDBD.getP16_POSITIVE()), $(qCRDBD.getP16_NEGATIVE()), $(qCRDBD.getPR_POSITIVE()), $(qCRDBD.getPR_NEGATIVE()), $(qCRDBD.getIDH1_POSITIVE()), $(qCRDBD.getIDH1_NEGATIVE()), $(qCRDBD.getIDH2_POSITIVE()), $(qCRDBD.getIDH2_NEGATIVE()), $(qCRDBD.getEGFR_POSITIVE()), $(qCRDBD.getEGFR_NEGATIVE()), $(qCRDBD.getALK_POSITIVE()), $(qCRDBD.getALK_NEGATIVE()), $(qCRDBD.getBRCA1_POSITIVE()), $(qCRDBD.getBRCA1_NEGATIVE()), $(qCRDBD.getBRCA2_POSITIVE()), $(qCRDBD.getBRCA2_NEGATIVE()), $(qCRDBD.getC_MYC_POSITIVE()), $(qCRDBD.getC_MYC_NEGATIVE()), $(qCRDBD.getAR_POSITIVE()), $(qCRDBD.getAR_NEGATIVE()), $(qCRDBD.getKRAS_POSITIVE()), $(qCRDBD.getKRAS_NEGATIVE())))
                .from($(qCRDBD))
                .fetch();
