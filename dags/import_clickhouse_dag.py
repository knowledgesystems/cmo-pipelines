"""
import_clickhouse_dag.py
Unified import DAG supporting ClickHouse (blue/green) flows.
"""
...
with DAG(
    ...
    params={
        "importer": Param("genie", type="string", enum=["public", "msk", "genie"], title="Import Pipeline", description="Determines which importer to use."),
