...
class TestSampleFileValidation(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.base_dir = 'test-py3/resources/validation_utils/sample_file'
    ...
    def compare_expected_output_to_actual(self, sub_dir):
        input_sample_file = os.path.join(TestSampleFileValidation.base_dir, sub_dir, "data_clinical_sample.txt")
        output_file = os.path.join(TestSampleFileValidation.base_dir, sub_dir, 'data_clinical_sample_output.txt')
        expected_file = os.path.join(TestSampleFileValidation.base_dir, sub_dir, 'data_clinical_sample_expected.txt')
