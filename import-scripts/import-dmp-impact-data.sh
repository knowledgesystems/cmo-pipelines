...
if ! $PORTAL_HOME/scripts/import-msk-preimport-steps-for-clickhouse.sh ; then
    echo "error : script import-msk-preimport-steps-for-clickhouse.sh exited with failure status"
    exit 1
fi
