...
if [ $? -ne 0 ] ; then
    ...
    # TODO remove transposed file after testing narrow format
...
# now remove the tansposed data cna file we just created TODO remove after testing narrow format
rm "$MSK_SOLID_HEME_DATA_HOME/data_CNA_transposed.txt" # TODO remove after testing narrow format
