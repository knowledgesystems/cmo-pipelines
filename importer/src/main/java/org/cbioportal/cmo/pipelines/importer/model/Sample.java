 ...
 */
public class Sample {
    private static final int NO_SUCH_SAMPLE = -1;
    private static final String DEFAULT_SAMPLE_TYPE = "Primary Solid Tumor";
    ...
    public Sample(String stableId, int patientId, String typeOfCancerId) {
        this.INTERNAL_ID = NO_SUCH_SAMPLE;
        this.STABLE_ID = stableId;
        this.PATIENT_ID = patientId;
        this.SAMPLE_TYPE = DEFAULT_SAMPLE_TYPE;
        this.TYPE_OF_CANCER_ID = typeOfCancerId;
    }
    
    public Sample(int internalId, String stableId, String sampleType, int patientId, String typeOfCancerId) {
