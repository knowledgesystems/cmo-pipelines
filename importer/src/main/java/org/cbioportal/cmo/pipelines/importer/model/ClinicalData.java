...
public class ClinicalData {
    // default internal id if importing new clinical data record
    ...
    public ClinicalData(int internalId, String attrId, String attrVal) {
        this.INTERNAL_ID = internalId;
        this.ATTR_ID = attrId;
        this.ATTR_VALUE = attrVal;
    }
    
    public ClinicalData(String attrId, String attrVal) {
        this.INTERNAL_ID = DEFAULT_INTERNAL_ID;
        this.ATTR_ID = attrId;
        this.ATTR_VALUE = attrVal;
    }
